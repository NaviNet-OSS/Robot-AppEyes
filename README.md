...
- The [Eyes Selenium](https://pypi.python.org/pypi/eyes-selenium/1.15) page provides more information for that library.
...
* Eyes-Selenium 1.15 (Newer versions not tested). Access the downloads [here](https://pypi.python.org/pypi/eyes-selenium/1.15), or use pip install eyes-selenium.
...
test will not run.** To run the test, navigate to the atests directory in C:\Python folder. Open a command prompt within the *tests/acceptance* folder and run:
...
* The Height resolution should not be greater than 1000 which is the Applitools maximum setting.
